import { MyRegistersPage } from './../my-registers/my-registers';
import { ListRegistersPage } from './../list-registers/list-registers';
...
export class HomePage {
  ...
  listRegisters() {
    this.nav.push(ListRegistersPage);
  }

  myRegisters() {
    this.nav.push(MyRegistersPage);
  }

  createRegister()
  {
    this.nav.push(CreateRegisterPage);
  }
